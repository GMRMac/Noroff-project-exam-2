...
export default function Search({handleSearch,resetInput,inputEmpty}){
    ...
    const fullToday =  today.getFullYear()+ "-" + month + "-" + day; // Value for setting the date today as a "suggested" date
    const fullTomorrow =  today.getFullYear()+ "-" + month + "-" + (day+1); // Value for setting the date tomorrow as a "suggested" date
            ...
            <Row className="col-sm-12">
                <Col sm={{span:6, offset:3}}>
                    <div className="input--border">
                        <img src={houseIcon}  className="input__icon" alt="house icon" />
