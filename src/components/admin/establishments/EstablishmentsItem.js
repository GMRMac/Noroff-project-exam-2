    ...
    return(
        <Card className="card--admin">
            <Row>
                ...
                <Col sm={1} xs={4} className="button__card--delete"><img src={X} /></Col>
                <Col sm={1} xs={4} className="button__card--edit"><img src={pen} /></Col>
                <Col sm={1} xs={4} className="button__card--goto"><img src={arrowRight} /></Col>
            </Row>
        </Card>
    )
}
