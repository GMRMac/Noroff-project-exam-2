...
$newEstablishment->additionalImageUrl = $_POST["additionalImageUrl"];
...
$establishmentsList = file_get_contents('../web/src/json/establishments.json');
...
file_put_contents('../web/src/json/establishments.json', $jsonData);
?>
