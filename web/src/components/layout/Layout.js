                            ...
                            <Navbar.Collapse id="basic-navbar-nav">
                                <Nav className="mr-auto" style={{width: "100%"}}>
                                    <Row style={{width: "100%", display: "block-inline"}}>
                                        <Col lg={2} style={{textAlign: "right", marginTop: "20px"}}><NavLink to="/contact/" className="nav-link">Contact us</NavLink></Col>
                                        <Col lg={2} style={{textAlign: "right", marginTop: "20px"}}><NavLink to="/" exact className="nav-link">Home</NavLink></Col>
                                        <Col lg={4}><NavLink to="/" exact>    
                                            <Navbar.Brand className="d-none d-lg-block">HOLIDAZE</Navbar.Brand>
                                        </NavLink></Col>
                                        <Col lg={2} style={{textAlign: "left", marginTop: "20px"}}><NavLink to="/login/" className="nav-link">Login</NavLink></Col>
                                    </Row>
                                </Nav>
                            </Navbar.Collapse>
                        </Navbar>
